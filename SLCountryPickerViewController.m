...
- (void)createSearchBar {
        if (self.tableView && !self.tableView.tableHeaderView) {
            ...
            [Backbutt setImage:[UIImage imageNamed:@"BackButtonIcon"] forState:UIControlStateNormal];
...
- (void)viewDidLoad
{
    ...
    self.navigationController.navigationBar.barTintColor = [UIColor colorWithRed:224.0/255.0f green:29.0/255.0f blue:40.0/255.0f alpha:0.9];
...
- (BOOL)searchBar:(UISearchBar *)searchBar shouldChangeTextInRange:(NSRange)range replacementText:(NSString *)text {
  ...
  return ([searchBar.text length] + [text length] - range.length > 4) ? NO : YES;
